...
print(f"List comprehension peak memory for {n_elements} elements: {with_list_comp(n_elements) / 1024:.2f} KB")
print(f"For loop peak memory for {n_elements} elements: {with_for_loop(n_elements) / 1024:.2f} KB")
