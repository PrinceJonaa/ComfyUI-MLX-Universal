...
> Last curated: 2026-06-28 at commit 348bcf7
...
### [RM-012] Standalone causal video VAE encode/decode nodes
- Status: Planned
- Evidence: `README.md` claimed "Standalone causal video and image VAE encode/decode nodes", but only Image VAE (`MLXEncoder`) is implemented in `nodes/diffusion_nodes.py`.
- Why it matters: Fulfills the documentation's claim of full video VAE multimodal support.
...
### [RM-008] Extract video generation subprocess and CV2 logic — completed 2026-06-28
...
## Deferred / Rejected
- **[RM-010] Native Kokoro Integration** — removed 2026-06-28. Reason: False premise; README correctly scopes these features, and does not claim Kokoro integration.
