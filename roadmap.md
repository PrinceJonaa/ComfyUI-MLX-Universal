...
### [RM-008] Extract video generation subprocess and CV2 logic — completed 2026-06-24
- Evidence: Moved `subprocess.Popen` and `cv2` extraction to `runtime/video_processing.py`.
