...
from comfyui_mlx_universal.runtime.diffusion_processing import generate_image, encode_image, encode_clip_text
...
class TestRuntimeDiffusion(unittest.TestCase):
    ...
    def test_generate_image_error_handling(self):
        ...
        with self.assertRaisesRegex(ValueError, "invalid or missing conditioning input"):
            generate_image(
        ...
        with self.assertRaisesRegex(ValueError, "invalid or missing latent input"):
            generate_image(
                ...
                steps=4,
                cfg=0.0,
                mlx_positive_conditioning={"conditioning": "c", "pooled_conditioning": "p"},
