...
class TestRuntimeGenerate(unittest.TestCase):
    ...
    def test_execute_batch_image_description(
        ...
        mock_apply_chat_template.return_value = "vlm_batch_formatted_prompt"
        ...
        mock_apply_chat_template.assert_called_with(
            mocked_model.processor,
            mocked_model.model.config,
            "Describe this batch",
            num_images=1,
        ...
        self.assertEqual(kwargs["image"], ["mock_img_1"])

        # Verify second call
        args, kwargs = mock_generate.call_args_list[1]
        self.assertEqual(kwargs["image"], ["mock_img_2"])
