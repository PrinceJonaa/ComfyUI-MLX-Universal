...
class TestRuntimeGenerate(unittest.TestCase):
    ...
    def test_execute_text_generation_with_chat_template(self, mock_mx):
        mock_mlx_lm_sample_utils.make_sampler.return_value = "mocked_sampler"
        ...
        mock_mlx_lm_sample_utils.make_sampler.assert_called_once_with(
            temp=0.7, top_p=0.9
        )
    ...
    @patch("comfyui_mlx_universal.runtime.generate_processing.mx")
    def test_execute_text_generation_without_chat_template(self, mock_mx):
        mock_mlx_lm_sample_utils.make_sampler.return_value = "mocked_sampler_2"
        mocked_model = self.get_mocked_model()
    ...
    def test_execute_image_description_no_draft_model(
        self, mock_tensor_to_pil, mock_os_exists, mock_mx
    ):
