...
class TestSAMNodes(unittest.TestCase):
    ...
    def test_predict_happy_path(self):
        ...
        mock_sam_predictor_cls.assert_called_once_with("internal_model", "internal_processor", score_threshold=0.4)
        mock_predictor.predict.assert_called_once_with(mock_pil_img, text_prompt="a cat")
        self.sam_nodes.process_sam3_result.assert_called_once_with(mock_detection_result, mock_pil_img)
