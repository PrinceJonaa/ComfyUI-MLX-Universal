...
"""
    ...
    def test_mlx_lm_generate_unknown_model_family_raises_value_error(self):
        ...
        self.assertEqual(str(context.exception), "Expected model family to be 'mlx-lm'. + Got model family 'unknown-family'. + Please use a standard language model and ensure the correct model type is selected in the MLX Load Model node.")
    ...
    def test_mlx_vlm_run_unknown_model_family_raises_value_error(self):
        ...
        self.assertEqual(str(context.exception), "Expected model family to be 'mlx-vlm'. + Got model family 'unknown-family'. + Please use a vision language model and ensure the correct model type is selected in the MLX Load Model node.")
