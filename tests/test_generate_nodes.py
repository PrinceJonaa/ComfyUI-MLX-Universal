...
class TestGenerateNodes(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.MLXBatchVLMDescribe = cls.generate_nodes.MLXBatchVLMDescribe
    ...
    def test_mlx_batch_vlm_run_happy_path(self, mock_execute):
        ...
        mock_execute.return_value = ["image 1 described", "image 2 described"]
        ...
        self.assertEqual(self.MLXBatchVLMDescribe.OUTPUT_IS_LIST, (True,))
        self.assertEqual(self.MLXBatchVLMDescribe.RETURN_TYPES, ("STRING",))
