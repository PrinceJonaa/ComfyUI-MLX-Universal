...
"""
    ...
    def test_mlx_lm_generate_unknown_model_family_raises_value_error(self):
        ...
        self.assertEqual(str(context.exception), "Expected model family 'mlx-lm' for text generation, but got 'unknown-family'. This usually means you connected a vision or SAM model to a text generation node. Please connect a text model like Qwen or Llama.")
    ...
    def test_mlx_vlm_run_unknown_model_family_raises_value_error(self):
        ...
        self.assertEqual(str(context.exception), "Expected model family 'mlx-vlm' for image understanding, but got 'unknown-family'. This usually means you connected a text-only model to a vision node. Please connect a vision model like Qwen-VL or LLaVA.")
