...
"""
    ...
    def test_mlx_lm_generate_unknown_model_family_raises_value_error(self):
        ...
        self.assertEqual(str(context.exception), "Expected a language model (family='mlx-lm') + Found family='unknown-family' instead + Please connect a model loaded via MLX Load Model with model_type='mlx-lm' or 'auto'.")
    ...
    def test_mlx_vlm_run_unknown_model_family_raises_value_error(self):
        ...
        self.assertEqual(str(context.exception), "Expected a vision-language model (family='mlx-vlm') + Found family='unknown-family' instead + Please connect a model loaded via MLX Load Model with model_type='mlx-vlm' or 'auto'.")
