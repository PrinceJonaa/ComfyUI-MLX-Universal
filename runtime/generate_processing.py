...
def execute_batch_image_description(
    ...
    This logic iterates over a batched image tensor and returns a list of strings.
    """
    mx.random.seed(seed)
    import mlx_vlm
    from mlx_vlm.prompt_utils import apply_chat_template
    ...
    if not pil_images:
        ...
        print(f"Describing (no image) (max {max_tokens} tokens)...")
        response = mlx_vlm.generate(
            mlx_model.model,
            mlx_model.processor,
            formatted_prompt,
