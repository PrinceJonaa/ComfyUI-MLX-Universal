...
| ![Active](https://img.shields.io/badge/●-ACTIVE-7c3aed?style=flat-square&labelColor=0d0d0d) | **Audio** | `mlx-whisper` / `Kokoro` | Native Whisper transcription and Kokoro TTS generation. |
| ![Active](https://img.shields.io/badge/●-ACTIVE-7c3aed?style=flat-square&labelColor=0d0d0d) | **Embeddings** | `mlx_embeddings` | Native text embeddings. |
