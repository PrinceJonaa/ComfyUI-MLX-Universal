            ...
            "required": {
                "model_path": (
                    "STRING",
                    {
                        ...
                        "tooltip": "Hugging Face repository ID or local path to the MLX model.",
                    },
                ),
                "model_type": (
                    ...
                    {
                        "default": "auto",
                        "tooltip": "The model architecture family. Leave as 'auto' in most cases.",
                    },
                ),
                "trust_remote_code": (
                    "BOOLEAN",
        ...
        return {
            "required": {
                ...
                "model_family": (
                    ...
                    {
                        "default": "mlx-lm",
                        "tooltip": "The expected architecture family of the draft model.",
                    },
                ),
            }
        }
