        ...
        return {
            "required": {
                ...
                "model_type": (
                    ...
                    {
                        "default": "auto",
                        "tooltip": "The specific model family (e.g., 'mlx-lm', 'mlx-vlm', 'sam3'). Set to 'auto' to detect from the config.",
                    },
                ),
                "trust_remote_code": (
                    "BOOLEAN",
            ...
            "required": {
                "model_path": (
                    "STRING",
                    {
                        ...
                        "tooltip": "Hugging Face repo ID or local path for the draft model.",
                    },
                ),
                "model_family": (
                    ["mlx-lm", "mlx-vlm"],
                    {
                        "default": "mlx-lm",
                        "tooltip": "The model family of the draft model.",
                    },
                ),
            }
        }
