    ...
    def load_model(
        ...
        def _load():
            ...
            if resolved_type == "mlx-lm":
                ...
                raise ValueError(f"Expected resolved model type to be one of ['mlx-lm', 'mlx-vlm', 'sam3']. + Got unknown resolved model type '{resolved_type}'. + Please ensure the model type is properly configured or override 'auto' with the correct type.")
